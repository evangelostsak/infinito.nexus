...
const ssoFlavor = decodeDotenvQuotedValue(process.env.SSO_FLAVOR) || "oidc";
const taigaOauth2Enabled = ssoEnabled && ssoFlavor === "oauth2";
const taigaOidcEnabled = ssoEnabled && ssoFlavor === "oidc";
